...
export interface ProjectActions {
  list: { request: z.infer<typeof ProjectListRequestSchema>; response: z.infer<typeof ProjectListResponseSchema> };
  create: { request: z.infer<typeof ProjectCreateRequestSchema>; response: z.infer<typeof ProjectCreateResponseSchema> };
  delete: { request: z.infer<typeof ProjectDeleteRequestSchema>; response: z.infer<typeof ProjectDeleteResponseSchema> };
  config: { request: z.infer<typeof ProjectConfigRequestSchema>; response: z.infer<typeof ProjectConfigResponseSchema> };
}
...
export interface WorkspaceActions {
  create: { request: z.infer<typeof WorkspaceCreateRequestSchema>; response: z.infer<typeof WorkspaceCreateResponseSchema> };
  list: { request: z.infer<typeof WorkspaceListRequestSchema>; response: z.infer<typeof WorkspaceListResponseSchema> };
  enter: { request: z.infer<typeof WorkspaceEnterRequestSchema>; response: z.infer<typeof WorkspaceEnterResponseSchema> };
  suspend: { request: z.infer<typeof WorkspaceSuspendRequestSchema>; response: z.infer<typeof WorkspaceSuspendResponseSchema> };
  resume: { request: z.infer<typeof WorkspaceResumeRequestSchema>; response: z.infer<typeof WorkspaceResumeResponseSchema> };
  destroy: { request: z.infer<typeof WorkspaceDestroyRequestSchema>; response: z.infer<typeof WorkspaceDestroyResponseSchema> };
}
...
export interface AgentActions {
  chat: { request: z.infer<typeof AgentChatRequestSchema>; response: z.infer<typeof AgentChatResponseSchema> };
  cancel: { request: z.infer<typeof AgentCancelRequestSchema>; response: z.infer<typeof AgentCancelResponseSchema> };
  approve: { request: z.infer<typeof AgentApproveRequestSchema>; response: z.infer<typeof AgentApproveResponseSchema> };
  reject: { request: z.infer<typeof AgentRejectRequestSchema>; response: z.infer<typeof AgentRejectResponseSchema> };
  history: { request: z.infer<typeof AgentHistoryRequestSchema>; response: z.infer<typeof AgentHistoryResponseSchema> };
}
...
export interface TerminalActions {
  create: { request: z.infer<typeof TerminalCreateRequestSchema>; response: z.infer<typeof TerminalCreateResponseSchema> };
  write: { request: z.infer<typeof TerminalWriteRequestSchema>; response: z.infer<typeof TerminalWriteResponseSchema> };
  resize: { request: z.infer<typeof TerminalResizeRequestSchema>; response: z.infer<typeof TerminalResizeResponseSchema> };
  close: { request: z.infer<typeof TerminalCloseRequestSchema>; response: z.infer<typeof TerminalCloseResponseSchema> };
  list: { request: z.infer<typeof TerminalListRequestSchema>; response: z.infer<typeof TerminalListResponseSchema> };
}
...
export interface FileActions {
  tree: { request: z.infer<typeof FileTreeRequestSchema>; response: z.infer<typeof FileTreeResponseSchema> };
  read: { request: z.infer<typeof FileReadRequestSchema>; response: z.infer<typeof FileReadResponseSchema> };
  write: { request: z.infer<typeof FileWriteRequestSchema>; response: z.infer<typeof FileWriteResponseSchema> };
  search: { request: z.infer<typeof FileSearchRequestSchema>; response: z.infer<typeof FileSearchResponseSchema> };
  watch: { request: z.infer<typeof FileWatchRequestSchema>; response: z.infer<typeof FileWatchResponseSchema> };
}
...
export interface GitActions {
  status: { request: z.infer<typeof GitStatusRequestSchema>; response: z.infer<typeof GitStatusResponseSchema> };
  diff: { request: z.infer<typeof GitDiffRequestSchema>; response: z.infer<typeof GitDiffResponseSchema> };
  log: { request: z.infer<typeof GitLogRequestSchema>; response: z.infer<typeof GitLogResponseSchema> };
  stage: { request: z.infer<typeof GitStageRequestSchema>; response: z.infer<typeof GitStageResponseSchema> };
  commit: { request: z.infer<typeof GitCommitRequestSchema>; response: z.infer<typeof GitCommitResponseSchema> };
  branch: { request: z.infer<typeof GitBranchRequestSchema>; response: z.infer<typeof GitBranchResponseSchema> };
}
